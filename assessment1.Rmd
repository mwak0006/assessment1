...
```{r figure2, out.width= "60%", fig.cap= "Aggregate Energy Consumption and Population Numbers", warning=FALSE}
...
Refering to figure \@ref(fig:figure1) it shows that:
...
The figure \@ref(fig:figure2) shows the:

* *Aggregate energy consumption has increased since 1985 and has had periods of decline but overall trended upwards*
* *Aggregate population numbers has increased consistently since 1985.*
