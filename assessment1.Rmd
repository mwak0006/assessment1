...
The second table \@ref(tab:table2) aggregates the country data and provides the Averages and Totals of Energy Consumption (kWh) by Capita and Population (Millions) Number.
...
* *Aggregate energy consumption has overall trended upwards since 1985 with certain periods of distinct negative growth such as 2009(Post GFC) and 2020 (COVID-19 pandemic). Aggregate population numbers has increased consistently since 1985.*
